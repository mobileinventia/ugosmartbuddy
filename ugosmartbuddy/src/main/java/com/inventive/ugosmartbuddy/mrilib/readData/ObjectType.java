...
public enum ObjectType {
     ...
     * Refer to an object of this type by its logical name, using the OBIS_Codes
     * identification code.
     */
    EXTENDED_REGISTER(4),
    /*
     ...
     * an object of this type by its logical name, using the OBIS_Codes identification
     * code.
     */
    REGISTER(3),
    /*
     ...
     * logical name = OBIS_Codes identification code needs to be identical. <p />
     ...
     * together with objects of Schedule, or ActivityModel Calendar.
     */
