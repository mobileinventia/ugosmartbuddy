...
public class GXDLMSConverter {
    /**
     * Collection of standard OBIS_Codes codes.
     */
    ...
    /**
     * Get OBIS_Codes code description.
     * 
     * @param logicalName
     *            Logical name (OBIS_Codes code).
     * @return Array of descriptions that match given OBIS_Codes code.
     */
    ...
    /**
     * Update OBIS_Codes code information.
     * 
     * @param it
     *            COSEM object.
     */
    private static void updateOBISCodeInfo(
        ...
        if (code != null) {
            ...
            System.out.println("Unknown OBIS_Codes Code: " + it.getLogicalName()
                    + " Type: " + it.getObjectType());
        }
    }

    /**
     * Update standard OBIS_Codes codes description and type if defined.
     * 
     * @param object
     *            COSEM object.
     */
    ...
    /**
     * Update standard OBIS_Codes codes descriptions and type if defined.
     * 
     * @param objects
    ...
    /**
     * Get country spesific OBIS_Codes codes.
     * 
     * @param standard
     *            Used standard.
    ...
    /**
     * Read standard OBIS_Codes code information from the file.
     * 
     * @param codes
     *            Collection of standard OBIS_Codes codes.
     */
