...
abstract class GXDLMS {
    ...
    static void getTcpData(final GXDLMSSettings settings,
        ...
        //System.out.println("Unknown version"+value);
        // TextFileHandler.loggedData("Unknown version"+value);
        if (value != 1) {
            // throw new GXDLMSException("Unknown version."); // Nitin read dsr
        }
