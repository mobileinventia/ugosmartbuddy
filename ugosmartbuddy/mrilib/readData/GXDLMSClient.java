...
public class GXDLMSClient {
     ...
     * of object is empty.
     * 
     * @return List of available OBIS_Codes codes.
     */
...
//        Log.d("TAG" , "Sending AARQ Request for--->" + GXCommon.bytesToHex(reply.get(0)));
    ...
    public final void parseAareResponse(final GXByteBuffer reply) {
        settings.setConnected(settings.getConnected() | ConnectionState.DLMS); // Require true
